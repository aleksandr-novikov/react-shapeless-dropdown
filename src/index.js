...
class Dropdown extends Component {
  ...
  open = () =>
    !this.state.opened &&
    this.setState({ opened: true }, () => this.props.onDropdownOpen());

  close = () =>
    this.state.opened &&
    this.setState({ opened: false }, () => this.props.onDropdownClose());
      ...
      >
        ...
        >
          ...
          {typeof this.props.button === 'string' && (
            <i style={arrowStyle(this.props, this.state)} />
          )}
        </div>
